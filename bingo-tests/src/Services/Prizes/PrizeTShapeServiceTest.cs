...
public class PrizeTShapeServiceTest
{

        private readonly ITestOutputHelper _output;
        private readonly PrizeTShapeService _service;
        private readonly Prize _prize;

        public PrizeTShapeServiceTest(ITestOutputHelper output)
        {
            _output = output;
            _prize = new Prize(1000);
            _service = new PrizeTShapeService(_prize);
        }
        [Fact]
