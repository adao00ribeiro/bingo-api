...
public class PrizeFullCardServiceTest
{
  
        private readonly ITestOutputHelper _output;
        private readonly PrizeFullCardService _service;
        private readonly Prize _prize;

        public PrizeFullCardServiceTest(ITestOutputHelper output)
        {
            _output = output;
            _prize = new Prize(1000);
            _service = new PrizeFullCardService(_prize);
        }
