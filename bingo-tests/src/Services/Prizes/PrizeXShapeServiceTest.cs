...
public class PrizeXShapeServiceTest
{

        private readonly ITestOutputHelper _output;
        private readonly PrizeXShapeService _service;
        private readonly Prize _prize;

        public PrizeXShapeServiceTest(ITestOutputHelper output)
        {
            _output = output;
            _prize = new Prize(1000);
            _service = new PrizeXShapeService(_prize);
        }
        [Fact]
