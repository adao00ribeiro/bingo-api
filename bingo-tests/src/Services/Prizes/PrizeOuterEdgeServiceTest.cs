...
public class PrizeOuterEdgeServiceTest
{

    private readonly ITestOutputHelper _output;
    private readonly PrizeOuterEdgeService _service;
    private readonly Prize _prize;

    public PrizeOuterEdgeServiceTest(ITestOutputHelper output)
    {
        _output = output;
        _prize = new Prize(1000);
        _service = new PrizeOuterEdgeService(_prize);
    }
    [Fact]
