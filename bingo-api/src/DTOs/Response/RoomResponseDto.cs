...
public record RoomResponseDto
{
    ...
    public RoomResponseDto(Guid id, string name, Guid ownerId, SellerResponseDto? owner, IEnumerable<RoomSellerResponseDto> roomSellers, AccumulatedResponseDto accumulated)
    {
        Id = id;
        Name = name;
        OwnerId = ownerId;
