...
public interface ICardRepository : IRepositoryBase<Card>
{
    ...
    Task<IEnumerable<Card>> GetAllByRoundId(Guid punterId, Guid roundId, int? page = null, int? size = null, Func<IQueryable<Card>, IQueryable<Card>>? includeProperties = null);
}