...
builder.Services.AddCors(options =>
{
    ...
    {
        policy.WithOrigins("http://homologation-bingo-api.srv813210.hstgr.cloud","http://homologation-bingo-dashboard.captain.localhost", "http://localhost", "http://localhost:4200", "http://localhost:4300", "https://localhost:4200", "https://localhost:4300")
              .AllowAnyMethod()
              .AllowAnyHeader()
              .AllowCredentials();
    });
